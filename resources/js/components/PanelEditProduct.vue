<template>
    ...
    <div class="container">
        ...
        <form @submit.prevent="editProduct">
            ...
            <vue-select-image ref="cover_image_select" :h="'100'" :w="'100'"  :dataImages="dataImages"
                              @onselectimage="onSelectImage"
                              :selectedImages="form.selectedCoverImage">
            </vue-select-image>
            ...
            <div class="row justify-content-center">
                ...
                <vue-select-image ref="galary_image_select" :h="'100'" :w="'100'"  :dataImages="dataImages2"
                                  :is-multiple="true"
                                  :selectedImages="form.selectedGalleryImage"
    ...
    export default {
        ...
        data(){
            return{
                ...
                brands:{},
                categories:{},
                testselected:[{id:55},{id:56},{id:57},{id:58}],
        ...
        methods:{
            ...
            editProduct(){
               ...
               this.form.overview =  tinymce.activeEditor.getContent();
                   ...
                   this.form.put(this.baseUrl()+'product/'+this.form.id)
                       .then((res)=>{
            ...
            preEditInitialDetails(){
                axios.get(this.baseUrl()+'pre-product-edit-details/'+this.$props.ProductId)
                    .then((response) => {
                        ...
                        this.form.general_name = product.GeneralName;
                        this.form.model_name = product.ModelName;
                        this.form.price = product.Price;
                        this.form.description = product.Description;
                        tinymce.activeEditor.setContent(product.Overview);
                        this.form.category_id = product.CategoryId;
                        this.form.brand_id = product.BrandId;


                        media.forEach((photo)=>{
                            if(photo.is_secondary === 1)
                            {
                                this.form.selectedGalleryImage.push({id:photo.id});
                            }else{
                                this.form.selectedCoverImage.push({id:photo.id});
                            }
                        });

                        let component =  this.$refs.cover_image_select;
                        let component2 =  this.$refs.galary_image_select;
                        component.setInitialSelection();
                        component2.setInitialSelection();

                        tags.forEach((tag)=>{
                            this.form.selected_tags.push({id: tag.id , name:tag.name});
                        });
